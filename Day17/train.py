...
def main():
    ...
    # Connect this Python application to our MLflow server using service
...
if __name__ == "__main__":
    ...
    if args.compile:
        ...
        print("Generated file: iris_pipeline.yaml")
